...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=4105824152ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="206">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=blooddonationsystem&table=admin">`blooddonationsystem`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=blooddonationsystem&table=add_patient">`blooddonationsystem`.`add_patient`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=blooddonationsystem&table=r_form">`blooddonationsystem`.`r_form`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=blooddonationsystem&table=appointment">`blooddonationsystem`.`appointment`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=blooddonationsystem&table=donor">`blooddonationsystem`.`donor`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=blooddonationsystem&table=account">`blooddonationsystem`.`account`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=blooddonationsystem&table=blood_sample">`blooddonationsystem`.`blood_sample`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=blooddonationsystem&table=lab_assistant">`blooddonationsystem`.`lab_assistant`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=blooddonationsystem&table=manager">`blooddonationsystem`.`manager`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=blooddonationsystem&table=report">`blooddonationsystem`.`report`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="5f3c4e342a5a2350325b4f362e374862">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="206"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
...
<div id="topmenucontainer" class="menucontainer">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="blooddonationsystem" targettable="blood_sample">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `blood_sample`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="blooddonationsystem" targettable="appointment">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `appointment`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="blooddonationsystem" targettable="appointment">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `appointment`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="blooddonationsystem" targettable="account">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `account`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="blooddonationsystem" targettable="account">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `appointment`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="blooddonationsystem" targettable="donor">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `donor`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="blooddonationsystem" targettable="appointment">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            targetdb="blooddonationsystem" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `donor` (
  `Did` int(11) NOT NULL,
  ...
  `Bloodgroup` varchar(20) NOT NULL
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `donor` (`Did`, `Username`, `Email`, `Password`, `Fullname`, `Contact`, `Age`, `Address`, `Gender`, `Bloodgroup`) VALUES
(22, &#039;Tharu1997&#039;, &#039;tharushaB@gmail.com&#039;, &#039;tharu@123&#039;, &#039;Tharusha Bandara&#039;, &#039;0769865321&#039;, &#039;25&#039;, &#039;Pothuhera, Kurunegala&#039;, &#039;male&#039;, &#039;B positive&#039;),
(23, &#039;Hasi@1&#039;, &#039;hasi1@gmail.com&#039;, &#039;@1has&#039;, &#039;Hasini Perera&#039;, &#039;0775659897&#039;, &#039;24&#039;, &#039;40/1,Boyagane, Anuradapura&#039;, &#039;female&#039;, &#039;O Negative&#039;),
(24, &#039;Thari99&#039;, &#039;tharinduk@gmail.com&#039;, &#039;99tharindu&#039;, &#039;Tharindu Kumara&#039;, &#039;0711512198&#039;, &#039;23&#039;, &#039;velvet Rd, Malabe&#039;, &#039;Male&#039;, &#039;B Negative&#039;),
(25, &#039;Sahan00&#039;, &#039;sahan00@gmail.com&#039;, &#039;200062S&#039;, &#039;Sahan Fernando&#039;, &#039;0778484958&#039;, &#039;22&#039;, &#039;Grand Kandian Rd,kandy&#039;, &#039;Male&#039;, &#039;B Positive&#039;),
(26, &#039;ShakilaK&#039;, &#039;shakilakumarihami@gmaill.com&#039;, &#039;colombo198@&#039;, &#039;Shakila Kumarihami&#039;, &#039;0725956321&#039;, &#039;32&#039;, &#039;TC Garden Rd, Battaramulla&#039;, &#039;female&#039;, &#039;B Negative&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="blooddonationsystem" targettable="donor">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `donor` ADD PRIMARY KEY(`Did`);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="blooddonationsystem" targettable="appointment">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `r_form` (
  `R_firstname` varchar(20) NOT NULL,
  `R_lastname` varchar(20) NOT NULL,
  `R_username` varchar(20) NOT NULL,
  `R_email` varchar(30) NOT NULL,
  `R_password` varchar(15) NOT NULL,
  `R_confirmpassword` varchar(15) NOT NULL,
  `R_nic` varchar(12) NOT NULL,
  `R_age` int(2) NOT NULL,
  `R_genderdetails` varchar(10) NOT NULL,
  `R_bloodtype` varchar(5) NOT NULL,
  `R_address` varchar(30) NOT NULL,
  `R_contactnumber` int(10) NOT NULL,
  `R_haveanydiesases` varchar(30) NOT NULL
);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="blooddonationsystem" targettable="r_form">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `r_form`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="blooddonationsystem" targettable="r_form">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `r_form` (`R_firstname`, `R_lastname`, `R_username`, `R_email`, `R_password`, `R_confirmpassword`, `R_nic`, `R_age`, `R_genderdetails`, `R_bloodtype`, `R_address`, `R_contactnumber`, `R_haveanydiesases`) VALUES
(&#039;Shamil&#039;, &#039;Rathnayake&#039;, &#039;Shami&#039;, &#039;shami@gmail.com&#039;, &#039;Shami@91&#039;, &#039;Shami@91&#039;, &#039;912584796315&#039;, 25, &#039;Male&#039;, &#039;A+&#039;, &#039;Horana&#039;, 751234568, &#039;no diseases&#039;),
(&#039;Lali&#039;, &#039;Peris&#039;, &#039;Lali&#039;, &#039;lali@gmail.com&#039;, &#039;Lali@91&#039;, &#039;Lali@91&#039;, &#039;984584796315&#039;, 23, &#039;Female&#039;, &#039;AB+&#039;, &#039;Colombo&#039;, 771277567, &#039;diabetic&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="blooddonationsystem" targettable="">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `add_patient` (
  ...
  `contactno` int(10) NOT NULL
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="blooddonationsystem" targettable="add_patient">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `add_patient`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="blooddonationsystem" targettable="add_patient">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `add_patient` (`name`, `adress`, `contactno`) VALUES
(&#039;chathura alwis&#039;, &#039;maradana&#039;, 2147483647),
(&#039;amal&#039;, &#039;kadawath&#039;, 1178646446),
(&#039;niamal&#039;, &#039;kadawatha&#039;, 2147483647);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="blooddonationsystem" targettable="admin">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
